...
class Template
{
    ...
    public function loadfromajax($file)    {
        // Eigenschaften zuweisen
        $this->templateName = $file;
        $this->templateFile = "../templates/".$file;
    ...
    public function assign($replace, $replacement) {
     ...
     public function assigns($replace, $replacement) {
       echo $this->template = str_replace( $this->leftDelimiter .$replace.$this->rightDelimiter,
    ...
    private function parseFunctions() {
        ...
        while( preg_match( "/{include file=\"(.*)\.(.*)\"}/isU", $this->template) )
        {
            $this->template = preg_replace_callback( "/{include file=\"(.*)\.(.*)\"}/isU",
